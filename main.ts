function GetFirstThreeNumber(value: string): string{
    return value.substring(0,3);    
}

function SortPhoneNumbersByCarrier(list: string[], viettel: string[], vinaphone: string[], mobiphone: string[] ){
    let viettelList: string[] = [];
    let vinaphoneList: string[] = [];
    let mobiphoneList: string[] = [];
